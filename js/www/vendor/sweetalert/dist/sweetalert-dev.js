...
// Question icon
"<div class=\"sa-icon sa-question\">?</div>" +
 ...
 */
var alertTypes = ['error', 'warning', 'info', 'success', 'question', 'input', 'prompt'];
...
var setParameters = function setParameters(params) {
  ...
  if (params.type && !(0, _utils.isIE8)()) {
    var _ret = (function () {
      ...
      var typesWithIcons = ['success', 'error', 'warning', 'info', 'question'];
      var $icon = undefined;
